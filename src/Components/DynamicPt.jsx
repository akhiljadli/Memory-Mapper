  ...
  const firstFit = () => {
    ...
    return (
      <div className="h-[30%] w-[90vw] flex flex-col justify-center items-center">
        <p className="text-3xl text-red-500 font-light mb-10">
          First Fit:
        </p>
        ...
        <div className="h-full w-full flex justify-evenly items-center mt-9">
          <p className="text-xl h-full text-black flex flex-col">
            External Fragmentation:{" "}
            <span className="text-red-400">{Fragmentation} KB</span>
          </p>
          <div className="h-full">
            <p className="text-xl text-black">Incomplete Processes:</p>
